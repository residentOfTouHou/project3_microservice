...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\Pro3\\project3_microservice\\guns\\guns-film\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"mtime_film_info_t","mtime_hall_film_info_t"});
