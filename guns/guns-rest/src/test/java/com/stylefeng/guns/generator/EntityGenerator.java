...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("E:\\microservice_group\\project3_microservice\\guns\\guns-rest\\src\\main\\java");//这里写你自己的java目录
        ...
        pc.setService("com.stylefeng.guns.rest.common.service");       //本项目没用，生成之后删掉
        pc.setServiceImpl("com.stylefeng.guns.rest.common.service.impl");   //本项目没用，生成之后删掉
